...
util.initRouterNode = function (routers, data) {
    for (var item of data) {
        ...
        meta.title = menu.title ? menu.title + " - 数据库监控平台" : null;
...
//判断是否是IE浏览器如果有window.ActiveXObject则证明是否则不是
util.isIE = function() {
...
/**
 * 防抖函数，在一段时间内触发n次事件，将前面的事件取消
 * **/
util.debounce = function(fn, time) {
  let timeId = null;
  return function() {
      let ctx = this,
          arg = arguments;
